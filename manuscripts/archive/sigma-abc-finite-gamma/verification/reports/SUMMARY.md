...
All currently executable exact residuals evaluate to ZERO; none to NONZERO. Definitions, assemblies, splits, and remainder claims use typed audit statuses rather than being misreported as algebraic identities.
...
Executable engine residuals: **36 ZERO**, **0 NONZERO**.
